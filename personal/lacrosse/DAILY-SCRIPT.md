...
## THE RESTRUCTURE FOR TUESDAY NIGHT CLUB

Tuesday club practice broke the original week. Two changes, and the second one matters most.

### Change 1: Tuesday is no longer a low day, so Saturday becomes one

Old week: Mon HIGH, Tue LOW, Wed HIGH, Thu LOW, Fri HIGH, Sat club, Sun off.
New week: **Mon HIGH, Tue CLUB, Wed HIGH, Thu LOW, Fri HIGH, Sat LOW, Sun OFF.**

Tuesday's prehab and tempo work moved to Saturday. Tuesday afternoon is now empty
...
fastest running of the week roughly 18 hours after a practice.

Peak hamstring strain happens in late swing at top speed, not in the first ten yards.
Roughly 60% of hamstring injuries occur during high-speed running, hamstring tear is
the third most reported injury in NCAA men's lacrosse, and sprinting at 95%+ on
residual fatigue is the specific scenario that causes it.

So:

- **Monday is now max velocity.** It is the freshest day of the week, coming off Sunday off.
- **Wednesday is now acceleration and heavy sled.** Short accelerations and sled work
  are far more tolerant of residual fatigue, because he is in a forward lean with short
  strides and never reaches the hip angles where hamstrings tear.

Club finishing by 8:30pm makes this workable. If it ever runs past 9pm two weeks
running, cut Wednesday's sled work to three reps and keep the lift.
...
Any of those means cut Wednesday's speed work to the warm-up plus three sled sprints
for a week.

---

## FAST RESULTS: WHAT MOVES AND WHAT DOES NOT

Estimates, not published norms. The reasoning is in each row.
...
**The takeaway:** the qualities that move fastest are the same ones that separate D1
lacrosse starters. Do not spend the fall chasing top-end speed. It is the slowest
thing on this list and it is a midfielder's currency, not a pole's.
...
## MONDAY MONITORING BLOCK (5 min, every Monday, before the warm-up)

Same scale, same surface, same shoes, same order, before any training.
...
### TUESDAY — CLUB PRACTICE. Nothing before it.

**After school: rest.** Eat properly. No training, no wall ball, no lifting.
...
Walk 20 to 30 minutes outside. Mobility 10 minutes. **Nine hours of sleep.**
...
Do not run the 300 yd shuttle at checkpoints. It wrecks everything and the number
...
- Trap bar 5x3 then 4x2 at 88–92% of the retested max
- Speed volume drops: Monday flying sprints to 3 reps, Wednesday sled to 3 reps
...
- Contrast pairs on both speed days: heavy sled then free sprint, trap bar then jump
- Monday returns to 4 flying sprints, now at Fly 20
...
- Two 40 minute lifts a week, 2–3 exercises, well away from games
- One speed exposure a week, 3 flying sprints, on the day furthest from a game
- Nordic and Copenhagen drop to once a week each
- **No added conditioning.** Games and practice are the conditioning.
- The job in season is film, not fitness.

### June to August 2027: The club circuit
...
Contact for his class opened 7:00 a.m. ET on 9 September 2026. Coaches evaluate through
the club circuit first, then film, then references. No amount of training in the next
eleven weeks changes an evaluation this fall.

Film and outreach are a separate project running in parallel, and it is the one that
decides this. See Part 6 of `D1-DEFENSE-PLAN.md`.
